...
const ExportXlsx = () => {
  ...
  const handleOnExport = () => {
    ...
    // append sheet to workbook and name DonateYourWayDonationSummary
    XLSX.utils.book_append_sheet(wb, ws, "DonateYourWayDonationSummary");
    
    // write xlsx file for download
    XLSX.writeFile(wb, "DonateYourWayDonationSummary.xlsx");
  };
